...
////
        ...
        $log_message = array_reverse(user_msg_log_get('', $account_id));//функция биллинга дает массив всех сообщений пользователю (включая "для всех" где только ссылка на айди в другом массиве)
