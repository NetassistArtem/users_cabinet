   ...
   public function sendEmailConfirm()
    {
        ...
        my_mail( 'artemkuchma@gmail.com', iconv_safe('utf-8','koi8-u',$full_email_text), iconv_safe('utf-8','koi8-u',$subject), $from_mail, $from_user);
        //  Debugger::testDie();
    ...
    public function sendSmsConfirm()
    {
        ...
        if ($number_valid !== -1) { //функция из апи биллинга, проверяет номер на возможность отправки смс.
            ...
            //  Debugger::testDie();
//$normal_phone
            turbosms_send('+380689828560', $full_sms_text, ''); //Открпвка смс, функция биллинга
