               ...
               //  Debugger::EhoBr('test');
                ...
                if($many <= $user_data['account_max_credit']){
                 ...
                 //   $service_fore_autocredit = array_search(2,$user_data['svc_credit_allowed']);
                  //  $service_fore_vip = array_search(1,$user_data['svc_credit_allowed']);
                  //  $service_fore_autocredit=1;
                   // Debugger::EhoBr('test');
                   // Debugger::VarDamp($service_fore_credit);
                   // Debugger::PrintR($user_data['svc_credit_allowed']);
                   // Debugger::testDie();
                  //  if($service_fore_credit !== false || $service_fore_vip !== false){// ||$service_fore_autocredit !== false) {
